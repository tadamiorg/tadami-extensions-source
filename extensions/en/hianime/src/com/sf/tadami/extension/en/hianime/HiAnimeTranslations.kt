...
val HiAnimeTranslations : Translations = mapOf(
    ...
    "sources_preferences_video_types_selection" to mapOf(
        Language.en to "Allowed video types",
        Language.fr to "Types de vidéos autorisés"
    ),
