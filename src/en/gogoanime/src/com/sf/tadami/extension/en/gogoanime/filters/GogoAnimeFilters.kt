...
object GogoAnimeFilters {
    ...
    class CountrySearchFilter : CheckBoxFilterList("Country",
        GogoAnimeFiltersData.COUNTRY_SEARCH_LIST
    )
    ...
    class LanguageSearchFilter : CheckBoxFilterList("Language",
        GogoAnimeFiltersData.LANGUAGE_SEARCH_LIST
    )
