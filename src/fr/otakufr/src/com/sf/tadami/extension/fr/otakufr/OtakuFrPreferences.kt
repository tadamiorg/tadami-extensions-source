...
data class OtakuFrPreferences(
    ...
    companion object : CustomPreferences<OtakuFrPreferences> {
        const val DEFAULT_BASE_URL = "https://otakufr.co/"
        ...
        override fun transform(preferences: Preferences): OtakuFrPreferences {
            return OtakuFrPreferences(
        ...
        override fun setPrefs(newValue: OtakuFrPreferences, preferences: MutablePreferences) {
